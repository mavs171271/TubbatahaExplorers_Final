...
namespace VisualStudio.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // Check if the UniqueUserName already exists in UserProfiles
                var existingUserProfile = await _context.UserProfiles
                    .FirstOrDefaultAsync(up => up.UniqueUserName == Input.UniqueUserName);

                if (existingUserProfile != null)
                {
                    ModelState.AddModelError("Input.UniqueUserName", "The username is already taken.");
