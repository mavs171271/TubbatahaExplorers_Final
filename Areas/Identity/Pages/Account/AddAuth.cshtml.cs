...
using VisualStudio.Areas.Identity.Pages.Account.Manage;

namespace VisualStudio.Areas.Identity.Pages.Account
{
    public class AddAuth : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // Pass the QR code image as base64 to the view
        ...
        private string GenerateQrCodeImage(string qrCodeUri)
        {
            ...
            {
                var qrCodeData = qrCodeGenerator.CreateQrCode(qrCodeUri, QRCodeGenerator.ECCLevel.Q);
                using (var qrCode = new BitmapByteQRCode(qrCodeData))
                {
                    var qrCodeImageBytes = qrCode.GetGraphic(20); // The number here controls the size of the QR code
